/*! Libreria para los codigos de barra JsBarcode v3.11.5 | (c) Johan Lindell | MIT license */
document.write(`<script src="${base_url}/Assets/js/plugins/JsBarcode.all.min.js"></script>`);
let tableProductos;
let rowTable;


//funcion que permite la utilizacion de enlaces en el texto que se coloque dentro del recuadro para la descripcion.
...
//Funcion para implementar el datatable de los productos.
tableProductos = $('#tableProductos').dataTable({
    ...
    'buttons': [{
        ...
        "exportOptions": { //para  exportar la cantidad de columnas
            "columns": [0, 1, 2, 3, 4, 5]
        }
    }, {
        "extend": "excelHtml5",
...
window.addEventListener('load', function() {
    ...
    // Funcion para insertar un producto desde el modal nuevo, o crear un nuevo propducto.
    if (document.querySelector("#formProductos")) {
        ...
        formProductos.onsubmit = function(e) {
            ...
            if (intCodigo.length < 5) { //Validacion pora la cantidad de digitos del codigo de barras
...
if (document.querySelector("#txtCodigo")) {
    ...
    inputCodigo.onkeyup = function() {
        if (inputCodigo.value.length >= 5) {
            ...
            fntBarcode(); //Funcion que hace el llamado para generar el codigo de barras
        } else {
...
// Funcion para la libreria de tinymce
tinymce.init({
...
//Funcion para ver la informacion desde el boton azul, ver.
...
// Funcion para editar productos desde el icono de aciones
...
// Funcion para mostrara las categorias en el modal de ingresar un producto.
function fntCategorias() {
    if (document.querySelector('#listCategoria')) {
        let ajaxUrl = base_url + '/Categorias/getSelectCategorias'; //Extraemos todas las categorias
        let request = (window.XMLHttpRequest) ?
            new XMLHttpRequest() :
            new ActiveXObject('Microsoft.XMLHTTP');
        request.open("GET", ajaxUrl, true);
...
// funcion que ejecuta el codigo de batrras
function fntBarcode() {
