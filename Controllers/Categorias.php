<?php 
	...
	class Categorias extends Controllers{
		...
		public function __construct(){
			parent::__construct();
			session_start();
			session_regenerate_id(true);//Generar e iliminar el id anterior de inicio de sesion.
        ...
        public function setCategoria(){
			...
			if($_POST){
				if(empty($_POST['txtNombre']) || empty($_POST['txtDescripcion']) || empty($_POST['listStatus']) ){
					...
					// Almacenamiento de datos del formulario en las sigueinets variables.
					$intIdcategoria = intval($_POST['idCategoria']);
					$strCategoria =  strClean($_POST['txtNombre']);
					$strDescipcion = strClean($_POST['txtDescripcion']);
					$intStatus = intval($_POST['listStatus']);
                    // Almacenamiento de datos de la imagen en las sigueinets variables.
					$foto   	 	= $_FILES['foto'];
					...
					$request_cateria = "";
                    // Validacion si se esta enviando imagen
					if($nombre_foto != ''){
        ...
        // Extraer datos de una categoria
